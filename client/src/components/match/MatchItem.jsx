      ...
      <Row className=''>
        <Col xs={ 5 } className='align-item-center justify-content-center'>
          ...
          <ListGroup className='align-items-center justify-content-center' variant="flush">
            {match.blackTeam.players.map(player => <ListGroup.Item key={ player._id}>{player.username}</ListGroup.Item>)}
          </ListGroup>
        </Col>
        ...
        <Col xs={ 5 } className=' align-items-center justify-content-center'>
          ...
          <ListGroup className='align-items-center justify-content-center' variant="flush">
            {match.whiteTeam.players.map(player => <ListGroup.Item key={ player._id}>{player.username}</ListGroup.Item>)}
          </ListGroup>
        </Col>
      </Row>
    </Container>);
